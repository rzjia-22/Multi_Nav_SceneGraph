...
export PYTHONPATH="${ros_bridge_root}/rclpy:${MNS_PROJECT_ROOT}:${MNS_PROJECT_ROOT}/ros_ws/src/mns_simulation:${PYTHONPATH:-}"
...
if [[ "${1:-}" == "--research-navigation" ]]; then
  runtime_script="${MNS_PROJECT_ROOT}/ros_ws/src/mns_simulation/mns_simulation/research_navigation_runtime.py"
  shift
fi
